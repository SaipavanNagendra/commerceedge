...
export function Login() {
  ...
  // If we just came from Register → verify-email, the email is passed
  // along so the person only has to type their password here.
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      // Docs: 401 for bad credentials, 429 for lockout after 3 wrong attempts
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-slate-900">Commerce Edge</span>
            </div>
            <nav className="hidden gap-8 sm:flex">
              ...
              <a href="#" className="text-sm font-medium text-slate-600 hover:text-slate-900">Enterprise</a>
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-slate-600">Access your academic and commercial insights</p>
          </div>
      ...
      <footer className="border-t border-slate-200 bg-slate-50 px-6 py-8">
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 md:grid-cols-5">
            <div>
              <p className="text-xs font-semibold uppercase text-slate-900">Product</p>
            ...
            <div>
              <p className="text-xs font-semibold uppercase text-slate-900">Company</p>
              <ul className="mt-3 space-y-2 text-sm">
            ...
            <div className="col-span-2 sm:col-span-2 md:col-span-3">
              <div className="space-y-2 text-xs text-slate-600">
                <p><a href="#" className="hover:text-slate-900">Privacy Policy</a> | <a href="#" className="hover:text-slate-900">Terms of Service</a> | <a href="#" className="hover:text-slate-900">Cookie Settings</a></p>
                <p>© 2026 Commerce Edge. All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
